...
public:
	...
	constexpr T& operator()(unsigned int i) { if (i == 0) return x; else if (i == 1) return y; return z; }
	constexpr const T& operator()(unsigned int i) const { if (i == 0) return x; else if (i == 1) return y; return z; }
	constexpr T& operator[](unsigned int i) { if (i == 0) return x; else if (i == 1) return y; return z; }
	constexpr const T& operator[](unsigned int i) const { if (i == 0) return x; else if (i == 1) return y; return z; }
